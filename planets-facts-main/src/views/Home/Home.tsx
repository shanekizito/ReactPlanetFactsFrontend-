...
export const Home = () => {
    ...
    const handleHover = (e: React.MouseEvent<HTMLAnchorElement>) => {
        ...
        gsap.to(e.currentTarget.querySelector(".corner-brkt-tl"), {
            x: -3,
            y: -3,
            duration: 0.4
        });
    ...
    return (
        <div className="relative min-h-screen overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none z-10">
                ...
                <div className="corner-brkt corner-brkt-tl m-12 scale-150 opacity-40" />
                <div className="corner-brkt corner-brkt-tr m-12 scale-150 opacity-40" />
                <div className="corner-brkt corner-brkt-bl m-12 scale-150 opacity-40" />
                <div className="corner-brkt corner-brkt-br m-12 scale-150 opacity-40" />
            </div>

            <div className="max-w-[1400px] mx-auto px-6 py-24 relative z-20">
                {/* Mission Control Hero */}
                <section ref={heroRef} className="min-h-[80vh] flex flex-col lg:flex-row items-center justify-between gap-16">
                    {/* 3D Planet Visualization */}
                    <div className="hero-anim w-full lg:w-1/2 h-[450px] lg:h-[550px] relative">
                    ...
                    <div className="w-full lg:w-1/2 space-y-8 text-center lg:text-left">
                        <div className="hero-anim flex items-center justify-center lg:justify-start gap-4 opacity-30">
                            ...
                            <span className="text-[9px] font-mono tracking-[0.8em] uppercase text-white/40">Exploration Hub</span>
                            <div className="w-12 h-[1px] bg-white/20" />
                        </div>

                        <h1 className="hero-anim text-7xl md:text-8xl lg:text-9xl font-black tracking-[-0.05em] leading-none text-white">
                            ORBITAL<span className="text-white/40">.</span>
                        </h1>

                        <p className="hero-anim text-base md:text-lg font-light text-white/50 max-w-xl mx-auto lg:mx-0 tracking-wide">
                            Explore the cosmos through interactive scientific modules and real-time 3D visualizations.
                        </p>

                        <div className="hero-anim flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <Link href="/planet/earth" className="btn-nasa active rounded-sm text-sm py-4 px-10">
                                Begin Exploration
                            </Link>
                            <button className="btn-nasa rounded-sm text-sm py-4 px-10 opacity-50 hover:opacity-100 transition-opacity">
                                Mission Archive
                            </button>
                        </div>
                    </div>
